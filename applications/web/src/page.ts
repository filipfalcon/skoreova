// The landing page view: the header/menu shell and every scroll section.
...
import { MountMotion, ObserveHeroPastHeader } from './motion';
...
// Shared view helpers and the shell live in components.ts.
