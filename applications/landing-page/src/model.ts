...
export const RevealState = Schema.Literals(['entered', 'drawn']);
...
export const Model = Schema.Struct({
  ...
  mapClub: Schema.Option(Schema.String),
  ...
  isMapAreaImperial: Schema.Boolean,
